...
export async function POST(request: NextRequest, response: NextResponse) {
	...
	console.log('file mp3: ' + fileMp3);
	console.log('file img: ' + fileImg);

	// console.log('------------------Test Files----------------');
	// console.log('file name: ' + fileMp3.name);
	// console.log('file type: ' + fileMp3.type);
	// console.log('file size:' + fileMp3.size);

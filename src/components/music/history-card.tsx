	...
	return (
		<div className='history-card p-4 rounded-xl bg-[var(--light-gray)] relative overflow-hidden flex items-center justify-start'>
			<div
				...
				className='play absolute w-[50px] h-[50px] cursor-pointer flex items-center justify-center bottom-3 right-3 '
			>
				<Button rounded>
					<PlayCircleOutlined className='' />
				</Button>
			</div>
			...
			<div className='flex flex-col ml-4 overflow-hidden'>
				<div>
					<h2 className='text-[22px] text-[var(--text-primary)] capitalize font-[Bungee] mb-2 whitespace-nowrap overflow-hidden'>
						{musicName}
					</h2>
				</div>
